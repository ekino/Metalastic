...
|----------------|---------------|-----------------|-------------------|
| 6.0.x | 8.18.x | ✅ 1.2.8 | `metalastic-elasticsearch-dsl:1.2.8` |
| 5.4.x - 5.5.x | 8.15.x - 8.18.x | ✅ 1.2.8 | `metalastic-elasticsearch-dsl-5.5:1.2.8` |
| 5.0.x - 5.3.x | 8.5.x - 8.13.x | ✅ 1.2.8 | `metalastic-elasticsearch-dsl-5.3:1.2.8` |
