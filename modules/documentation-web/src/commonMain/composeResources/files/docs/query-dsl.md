...
| Artifact | Spring Data ES | Brings Transitively |
|----------|---------------|---------------------|
| `elasticsearch-dsl-5.3` | 5.0.x - 5.3.x | 5.3.13 |
| `elasticsearch-dsl` | 5.4.x - 5.5.x | 5.5.6 |
...
- Explore path traversal API
- Learn about metamodel generation
