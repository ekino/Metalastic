...
// Elasticsearch DSL module for Spring Data ES 5.1.x

val springDataEsVersion = "5.1.12" // Latest 5.1.x release
val elasticsearchJavaVersion = "8.7.1"
...
dependencies {
  ...
  // Spring Data Elasticsearch 5.1.18
  api("org.springframework.data:spring-data-elasticsearch:$springDataEsVersion")

  // Force elasticsearch-java version to match Spring Data ES 5.1.x
...
tasks.register("showVersion") {
  doLast { println("elasticsearch-dsl-5.1 version: ${project.version}") }
}
