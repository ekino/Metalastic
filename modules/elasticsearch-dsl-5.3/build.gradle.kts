...
// Elasticsearch DSL module for Spring Data ES 5.3.x

val springDataEsVersion = "5.3.13" // Latest 5.3.x release
val elasticsearchJavaVersion = "8.13.4"
...
dependencies {
  ...
  // Spring Data Elasticsearch 5.3.13
  api("org.springframework.data:spring-data-elasticsearch:$springDataEsVersion")

  // Force elasticsearch-java version to match Spring Data ES 5.3.x
