...
object CodeGenerationUtils {
  ...
  private fun simplifyTypeNameWithoutImports(typeName: TypeName): String =
    when (typeName) {
      ...
      is ParameterizedTypeName -> {
        ...
        val typeArgs =
          typeName.typeArguments.joinToString(", ") { arg -> simplifyTypeNameWithoutImports(arg) }
  ...
  /**
   * Generates KDoc documentation for a generated field property. This is shared between
   * FieldGenerators and ObjectFieldRegistry.
   */
