 ...
 */
class MetamodelsBuilder(val graph: ElasticsearchGraph, val options: ProcessorOptions) {

  fun buildMetamodelsRegistry(): FileSpec? {
    val documents: List<ElasticsearchGraph.DocumentClass> =
   ...
   */
  private fun buildEntriesFunction(documents: List<ElasticsearchGraph.DocumentClass>): FunSpec {
   ...
   */
  private fun buildEntriesCodeBlock(documents: List<ElasticsearchGraph.DocumentClass>): CodeBlock {
