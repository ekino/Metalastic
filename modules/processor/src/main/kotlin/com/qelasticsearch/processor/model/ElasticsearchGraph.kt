...
class ElasticsearchGraph {
  private val models = mutableSetOf<QClassModel>()

  fun models(): Set<QClassModel> = models
  ...
  fun getModel(classDeclaration: KSClassDeclaration?): QClassModel? =
  ...
  sealed interface QClassModel {
    val parentModel: QClassModel?
    val sourceClassDeclaration: KSClassDeclaration
    val qClassName: String
    val fields: List<FieldModel>
    val graph: ElasticsearchGraph
