...
class MetamodelsConfigurationSpec :
  ShouldSpec({
    should("use default package when no overrides provided") {
      ...
      val mockGraph = mockk<MetalasticGraph>()
      val mockModel = mockk<MetalasticGraph.MetaClassModel>()
    ...
    should("find common ancestor package for multiple packages") {
      val config = MetamodelsConfiguration()
      val mockGraph = mockk<MetalasticGraph>()
      val mockModel1 = mockk<MetalasticGraph.MetaClassModel>()
      val mockModel2 = mockk<MetalasticGraph.MetaClassModel>()
