...
/**
 * Tests for the Metalastic processor provider and core functionality. Focus on actual processor
 * behavior rather than trivial operations.
 */
class ProcessorProviderSpec :
  ShouldSpec({
    should("create processor provider successfully") {
      val provider = MetalasticSymbolProcessorProvider()
    ...
    should("create symbol processor with environment") {
      ...
      processor.shouldBeInstanceOf<MetalasticSymbolProcessor>()
    }
