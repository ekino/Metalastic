...
public class JavaTestDocument {
    ...
    private List<com.metalastictest.integration.JavaTag> tags;
    ...
    public JavaTestDocument(String id, List<String> aList, List<ParametrizedType<String>> parametrizedTypeList,
                            ...
                            List<com.metalastictest.integration.JavaTag> tags, List<JavaTag> tags2,
    ...
    public List<com.metalastictest.integration.JavaTag> getTags() {
        return tags;
    }

    public void setTags(List<com.metalastictest.integration.JavaTag> tags) {
        this.tags = tags;
    }
