...
public class JavaTestDocument {
    ...
    private List<com.qelasticsearchtest.integration.JavaTag> tags;
    ...
    public JavaTestDocument(String id, List<String> aList, List<ParametrizedType<String>> parametrizedTypeList,
                            ...
                            List<com.qelasticsearchtest.integration.JavaTag> tags, List<JavaTag> tags2,
    ...
    public List<com.qelasticsearchtest.integration.JavaTag> getTags() {
        return tags;
    }

    public void setTags(List<com.qelasticsearchtest.integration.JavaTag> tags) {
        this.tags = tags;
    }
