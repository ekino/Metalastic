...
class MultiFieldSpec :
  ShouldSpec({
    should("support accessing multifield properties including main field") {
      ...
      MetaJavaTestDocument.javaTestDocument.multiFieldName.shouldNotBeNull()
      ...
      MetaJavaTestDocument.javaTestDocument.multiFieldName.search.shouldNotBeNull()
      MetaJavaTestDocument.javaTestDocument.multiFieldName.search.path() shouldBe
        "multiFieldName.search"

      MetaJavaTestDocument.javaTestDocument.multiFieldName.keyword.shouldNotBeNull()
      MetaJavaTestDocument.javaTestDocument.multiFieldName.keyword.path() shouldBe
        "multiFieldName.keyword"

      // Test the new 'somethingElse' field that was previously not accessible
      MetaJavaTestDocument.javaTestDocument.multiFieldName.somethingElse.shouldNotBeNull()
      MetaJavaTestDocument.javaTestDocument.multiFieldName.somethingElse.path() shouldBe
    ...
    should("be able to traverse multifield search path like user requested") {
      ...
      val searchFieldPath = MetaJavaTestDocument.javaTestDocument.multiFieldName.search.path()
    ...
    should("support different main field types in multifields") {
      ...
      MetaJavaTestDocument.javaTestDocument.description2.shouldNotBeNull()
      MetaJavaTestDocument.javaTestDocument.description2.path() shouldBe "description2"
