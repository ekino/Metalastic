...
class FieldTypeSpec :
    ShouldSpec({
        ...
        should("create KeywordField with correct properties") {
            val field = KeywordField<String>("document.status")
        ...
        should("construct dotted paths with parent") {
            val field = KeywordField<String>("document.type")
        ...
        should("create IntegerField correctly") {
            val field = IntegerField<Int>("document.count")
        ...
        should("create DoubleField correctly") {
            val field = DoubleField<Double>("document.price")
        ...
        should("create DateField correctly") {
            val field = DateField<Date>("document.createdAt")
        ...
        should("create BooleanField correctly") {
            val field = BooleanField<Boolean>("document.isActive")
        ...
        should("create LongRangeField correctly") {
            val field = LongRangeField("document.timestampRange")
        ...
        should("create GeoShapeField correctly") {
            val field = GeoShapeField("geo.boundary")
        ...
        should("create TokenCountField correctly") {
            val field = TokenCountField("analysis.wordCount")
        ...
        should("create RankFeatureField correctly") {
            val field = RankFeatureField("ranking.relevance")
        ...
        should("create FlattenedField correctly") {
            val field = FlattenedField("document.metadata")
        ...
        should("create ConstantKeywordField correctly") {
            val field = ConstantKeywordField("product.category")
        ...
        should("create PointField correctly") {
            val field = PointField("geo.coordinate")
        ...
        should("handle deep nested paths") {
            val field = KeywordField<String>("address.geo.country.code")
            field.path() shouldBe "address.geo.country.code"
        }

        should("handle parent path with dots") {
            val field = TextField<String>("user.profile.settings.name")
        ...
        should("create multiField") {
            ...
            class TestMultiField(
                path: String,
            ) : MultiField<TextField<String>>(TextField(path))

            val field = TestMultiField("mainField")
