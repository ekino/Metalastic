 ...
 */
class IndexAndObjectFieldsSpec : DescribeSpec({

    describe("Index creation and basic functionality") {
        
        it("should create Index with correct name and empty path") {
        ...
        it("should create fields with correct paths in Index") {
            val index = object : Index("user") {
        ...
        it("should maintain field types in Index") {
            val index = object : Index("product") {
    ...
    describe("ObjectFields creation and functionality") {
        
        it("should create ObjectFields with correct field types") {
        ...
        it("should handle empty ObjectFields") {
            class EmptyFields : ObjectFields()
            
            val empty = EmptyFields()
            // Should not throw any exceptions
            empty.shouldBeInstanceOf<ObjectFields>()
        }
    }

    describe("Object field traversal and path construction") {
        
        it("should construct correct paths for simple object fields") {
            class AddressFields : ObjectFields() {
                val city by text<String>()
                val country by keyword<String>()
            }
        ...
        it("should handle nested object fields correctly") {
            class LocationFields : ObjectFields() {
        ...
        it("should handle multiple object fields in same index") {
            class ContactFields : ObjectFields() {
                val email by keyword<String>()
    ...
    describe("Nested fields functionality") {
        
        it("should create nested fields correctly") {
            class TagFields : ObjectFields() {
                val name by keyword<String>()
                val weight by integer<Int>()
            }
            
            val article = object : Index("article") {
                val title by text<String>()
        ...
        it("should handle nested fields with object fields inside") {
            class LocationFields : ObjectFields() {
                val city by text<String>()
                val country by keyword<String>()
            }
            
            class EventFields : ObjectFields() {
                val name by text<String>()
                val location by objectField(LocationFields())
            }
            
            val user = object : Index("user") {
                val name by text<String>()
    ...
    describe("Mixed field types in complex structures") {
        
        it("should handle all field types in nested structures") {
    ...
    describe("Edge cases and error scenarios") {
        ...
        it("should handle ObjectFields with same field names in different contexts") {
            class CommonFields : ObjectFields() {
                val name by text<String>()
                val id by keyword<String>()
            }
            
            val index = object : Index("entity") {
    ...
    describe("Type safety verification") {
        ...
        it("should maintain type safety through object traversal") {
