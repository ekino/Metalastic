...
/**
 * Tests for the QElasticsearch processor provider and core functionality.
 * Focus on actual processor behavior rather than trivial operations.
 */
class ProcessorProviderSpec :
    ShouldSpec({
        ...
        should("support all Spring Data Elasticsearch FieldTypes for version compatibility") {
            ...
            logger.info { "FieldType compatibility check completed with ${allTypes.size} available types" }
        }
