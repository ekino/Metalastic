# Metalastic Elasticsearch DSL v1.0 for Spring Data ES 5.2.x

**Release Date:** TBD

## Overview

First release of the Metalastic Elasticsearch DSL module for **Spring Data Elasticsearch 5.2.x**.
...
dependencies {
    ...
    // DSL module for Spring Data ES 5.2.x
    implementation("com.ekino.oss:metalastic-elasticsearch-dsl-5.2:1.0")

    // Your Spring Data Elasticsearch dependency
    implementation("org.springframework.data:spring-data-elasticsearch:5.2.+")
}
```
